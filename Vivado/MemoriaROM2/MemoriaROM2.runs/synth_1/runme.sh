...
HD_PWD='C:/Users/alanm/Desktop/Arqui/Vivado/MemoriaROM2/MemoriaROM2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom2.tcl
