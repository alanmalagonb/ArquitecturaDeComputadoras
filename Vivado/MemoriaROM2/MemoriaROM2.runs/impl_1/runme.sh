...
HD_PWD='C:/Users/alanm/Desktop/Arqui/Vivado/MemoriaROM2/MemoriaROM2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom2.tcl -notrace
