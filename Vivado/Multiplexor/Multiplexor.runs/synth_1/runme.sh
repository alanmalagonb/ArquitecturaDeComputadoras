...
HD_PWD='C:/Users/alanm/Desktop/Arqui/Vivado/Multiplexor/Multiplexor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_2_To_1_Width.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_2_To_1_Width.tcl
